...
export default function EditListedBusiness() {
  ...
  const handelMapLoad = (map: any, maps: any) => {
    ...
    const marker = new AdvancedMarkerElement({
      ...
      gmpDraggable: true,
      position: {
        lat: data?.BusinessLocation?.coordinates[1] || 59.95,
        lng: data?.BusinessLocation?.coordinates[0] || 30.33,
      },
    });
    setMarker(marker);
  ...
  if (isLoading) return <FullLoadingComponent />;
  console.log(data);

  console.log(data?.BusinessHours?.monday.openTime);
        ...
        <div className="addressContainer">
          ...
          <div className="addressDetails">
            <TextField
              ...
              name="address"
              required
              value={data?.BusinessLocation?.address}
            ...
            <TextField
              ...
              name="city"
              required
              value={data?.BusinessLocation?.city}
            ...
            <TextField
              ...
              name="state"
              required
              value={data?.BusinessLocation?.state}
            ...
            <TextField
              ...
              name="country"
              required
              value={data?.BusinessLocation?.country}
            ...
            <TextField
              ...
              name="pinCode"
              required
              value={data?.BusinessLocation?.zip}
            ...
            <div className="dayTiming">
              ...
              <div className="openCloseTime">
                <TimePicker
                  ...
                  name="mondayOpenTime"
                  defaultValue={
                    data?.BusinessHours?.monday.openTime !== "not available"
                      ? dayjs(
                          `1970-01-01T${data.BusinessHours.monday.openTime}`
                        )
                      : null
                  }
                />
                <TimePicker
                  ...
                  label="Closing Time"
                  defaultValue={
                    data?.BusinessHours?.monday.closeTime !== "not available"
                      ? dayjs(
                          `1970-01-01T${data.BusinessHours.monday.closeTime}`
                        )
                      : null
                  }
                  // defaultValue={data?.BusinessHours?.monday.openTime}
            ...
            <div className="dayTiming">
              ...
              <div className="openCloseTime">
                <TimePicker
                  ...
                  label="Opening Time"
                  defaultValue={
                    data?.BusinessHours?.tuesday.openTime !== "not available"
                      ? dayjs(
                          `1970-01-01T${data.BusinessHours.tuesday.openTime}`
                        )
                      : null
                  }
                ...
                <TimePicker
                  ...
                  label="Closing Time"
                  defaultValue={
                    data?.BusinessHours?.tuesday.closeTime !== "not available"
                      ? dayjs(
                          `1970-01-01T${data.BusinessHours.tuesday.closeTime}`
                        )
                      : null
                  }
            ...
            <div className="dayTiming">
              ...
              <div className="openCloseTime">
                <TimePicker
                  ...
                  label="Opening Time"
                  defaultValue={
                    data?.BusinessHours?.wednesday.openTime !== "not available"
                      ? dayjs(
                          `1970-01-01T${data.BusinessHours.wednesday.openTime}`
                        )
                      : null
                  }
                ...
                <TimePicker
                  ...
                  label="Closing Time"
                  defaultValue={
                    data?.BusinessHours?.wednesday.closeTime !== "not available"
                      ? dayjs(
                          `1970-01-01T${data.BusinessHours.wednesday.closeTime}`
                        )
                      : null
                  }
            ...
            <div className="dayTiming">
              ...
              <div className="openCloseTime">
                <TimePicker
                  ...
                  label="Opening Time"
                  defaultValue={
                    data?.BusinessHours?.thursday.openTime !== "not available"
                      ? dayjs(
                          `1970-01-01T${data.BusinessHours.thursday.openTime}`
                        )
                      : null
                  }
                ...
                <TimePicker
                  ...
                  label="Closing Time"
                  defaultValue={
                    data?.BusinessHours?.thursday.closeTime !== "not available"
                      ? dayjs(
                          `1970-01-01T${data.BusinessHours.thursday.closeTime}`
                        )
                      : null
                  }
            ...
            <div className="dayTiming">
              ...
              <div className="openCloseTime">
                <TimePicker
                  ...
                  label="Opening Time"
                  defaultValue={
                    data?.BusinessHours?.friday.openTime !== "not available"
                      ? dayjs(
                          `1970-01-01T${data.BusinessHours.friday.openTime}`
                        )
                      : null
                  }
                  name="fridayOpenTime"
            ...
            <div className="dayTiming">
              ...
              <div className="openCloseTime">
                <TimePicker
                  ...
                  label="Opening Time"
                  defaultValue={
                    data?.BusinessHours?.saturday.openTime !== "not available"
                      ? dayjs(
                          `1970-01-01T${data.BusinessHours.saturday.openTime}`
                        )
                      : null
                  }
                ...
                <TimePicker
                  ...
                  label="Closing Time"
                  defaultValue={
                    data?.BusinessHours?.saturday.closeTime !== "not available"
                      ? dayjs(
                          `1970-01-01T${data.BusinessHours.saturday.closeTime}`
                        )
                      : null
                  }
            ...
            <div className="dayTiming">
              ...
              <div className="openCloseTime">
                <TimePicker
                  ...
                  label="Opening Time"
                  defaultValue={
                    data?.BusinessHours?.sunday.openTime !== "not available"
                      ? dayjs(
                          `1970-01-01T${data.BusinessHours.sunday.openTime}`
                        )
                      : null
                  }
                  name="sundayOpenTime"
                ...
                <TimePicker
                  ...
                  label="Closing Time"
                  defaultValue={
                    data?.BusinessHours?.sunday.closeTime !== "not available"
                      ? dayjs(
                          `1970-01-01T${data.BusinessHours.sunday.closeTime}`
                        )
                      : null
                  }
        ...
        <div className="contactContainer">
          ...
          <div className="contact">
            <TextField
              ...
              name="phoneNumber"
              defaultValue={
                data?.BusinessPhone === "NA" ? "" : data?.BusinessPhone
              }
            />
            <TextField
              label="Email"
              ...
              type="email"
              defaultValue={
                data?.BusinessEmail === "NA" ? "" : data?.BusinessEmail
              }
            />
            <TextField
              label="Website"
              ...
              name="website"
              defaultValue={
                data?.BusinessWebsite === "NA" ? "" : data?.BusinessWebsite
              }
            />
          </div>
        </div>
        <div className="socialMediaContainer">
          ...
          <div className="socialMedia">
            <TextField
              ...
              name="facebookLink"
              defaultValue={
                data?.BusinessSocial?.facebook === null ? "" : data?.BusinessSocialMedia?.facebook
              }
            ...
            <TextField
              ...
              name="instagramLink"
              defaultValue={
                data?.BusinessSocial?.instagram === null ? "" : data?.BusinessSocialMedia?.instagram
              }
              
            />
            <TextField label="Twitter" variant="outlined" name="twitterLink"
            defaultValue={
              data?.BusinessSocial?.twitter === null ? "" : data?.BusinessSocialMedia?.twitter
            }
            />
            <TextField
              label="LinkedIn"
              ...
              name="linkedinLink"
              defaultValue={
                data?.BusinessSocial?.linkedin === null ? "" : data?.BusinessSocialMedia?.linkedin
              }
            />
          </div>
        </div>
